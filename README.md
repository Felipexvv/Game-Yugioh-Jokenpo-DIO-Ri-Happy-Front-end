...
Projeto desenvolvido durante o Bootcamp [Ri Happy - Front-end do Zero #2](https://web.dio.me/track/ri-happy-front-end-do-zero) com o professor [Felipe Aguiar](https://github.com/felipeAguiarCode). O objetivo desse projeto é desenvolver um versão do tracional jogo "Pedra, Papel e Tesoura" com inspiração na temática de Yu-Gi-Oh, utilizando apenas HTML, CSS e Javascript.
